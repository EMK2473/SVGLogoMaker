...
class Shape {
  ...
  generateShape() {
    console.log(
      `${this.area} is ${this.color} and has ${this.textAndTextColor} as text`
    );
  }
}
...
class Circle extends Shape {
  constructor(color, textAndTextColor, r) {
    ...
    console.log(
      `This Circle is colored ${this.color} and has ${this.textAndTextColor} as text`
    );
  }
}
...
class Rectangle extends Shape {
  constructor(color, textAndTextColor, w, l) {
    ...
    console.log(
      `This Rectangle is colored ${this.color} and has ${this.textAndTextColor} as text`
    );
  }
}
...
class Triangle extends Shape {
  constructor(color, textAndTextColor, h, b) {
    ...
    console.log(
      `This Triangle is colored ${this.color} and has ${this.textAndTextColor} as text`
    );
  }
}
